...
MAIN:   
    jmp INIT         ; нерезидентная часть программы
    ...
    INSTALL_MSG DB  "Install new breaking!$"
    UNINSTALL_MSG DB "Uninstall new breaking!$"
    
MY_BREAKING:
    pusha             ; сохраняет в стеке содержимое 16-битных РОН
    push es           ; es хранит данные 
    push ds           ; ds хранит код PSP
...
INSTALL:    
    ...
    mov ah, 9                   ; Функция DOS 09h вывода строки
	int 21h                     ; вызов DOS 
